...
constexpr const char* COLLISIONBLOCKMAPS_TAG = "COLLISIONBLOCKMAPS";
...
constexpr const char* LIBRARY_MDK_TAG = "LIBRARY_MDK";
constexpr const char* LIBRARY_SGDK_TAG = "LIBRARY_SGDK";
...
constexpr const char* C_COLLISIONBLOCKMAP_TEMPLATE = R"(
...
{{#PALETTES}}{{> c_palette}}{{/PALETTES}}{{#TILESETS}}{{> c_tileset}}{{/TILESETS}}{{#TILEMAPS}}{{> c_tilemap}}{{/TILEMAPS}}{{#TILEMAPARRAYS}}{{> c_tilemaparray}}{{/TILEMAPARRAYS}}{{#BLOCKMAPS}}{{> c_blockmap}}{{/BLOCKMAPS}}{{#COLLISIONBLOCKMAPS}}{{> c_collisionblockmap}}{{/COLLISIONBLOCKMAPS}}{{#SPRITEARRAYS}}{{> c_spritearray}}{{/SPRITEARRAYS}}
)";
...
constexpr const char* H_COLLISIONBLOCKMAP_TEMPLATE = R"(
...
{{#LIBRARY_SGDK}}#include <genesis.h>{{/LIBRARY_SGDK}}{{#LIBRARY_MDK}}#include <stdint.h>{{/LIBRARY_MDK}}
{{#PALETTES}}{{> h_palette}}{{/PALETTES}}{{#TILESETS}}{{> h_tileset}}{{/TILESETS}}{{#TILEMAPS}}{{> h_tilemap}}{{/TILEMAPS}}{{#SPRITES}}{{> h_sprite}}{{/SPRITES}}{{#TILEMAPARRAYS}}{{> h_tilemaparray}}{{/TILEMAPARRAYS}}{{#BLOCKMAPS}}{{> h_blockmap}}{{/BLOCKMAPS}}{{#COLLISIONBLOCKMAPS}}{{> h_collisionblockmap}}{{/COLLISIONBLOCKMAPS}}{{#SPRITEARRAYS}}{{> h_spritearray}}{{/SPRITEARRAYS}}
...
#define {{NAME}}_TILE_COUNT {{TILE_COUNT}}{{#START_TILE_IDX}}
#define {{NAME}}_START_IDX {{START_TILE_IDX}}{{/START_TILE_IDX}}
