...
constexpr const char* CEILING_ROWS_TAG = "CEILING_ROWS";
constexpr const char* COLLISIONBLOCKARRAYS_TAG = "COLLISIONBLOCKARRAYS";
constexpr const char* COLORS_TAG = "COLORS";
constexpr const char* COLOR_TAG = "COLOR";
constexpr const char* FLOOR_ROWS_TAG = "FLOOR_ROWS";
...
{{#PALETTES}}{{> c_palette}}{{/PALETTES}}{{#TILESETS}}{{> c_tileset}}{{/TILESETS}}{{#TILEMAPS}}{{> c_tilemap}}{{/TILEMAPS}}{{#TILEMAPARRAYS}}{{> c_tilemaparray}}{{/TILEMAPARRAYS}}{{#BLOCKMAPS}}{{> c_blockmap}}{{/BLOCKMAPS}}{{#SPRITEARRAYS}}{{> c_spritearray}}{{/SPRITEARRAYS}}{{#COLLISIONBLOCKARRAYS}}{{> c_collisionblockarray}}{{/COLLISIONBLOCKARRAYS}}
)";
...
#include <genesis.h>
{{#PALETTES}}{{> h_palette}}{{/PALETTES}}{{#TILESETS}}{{> h_tileset}}{{/TILESETS}}{{#TILEMAPS}}{{> h_tilemap}}{{/TILEMAPS}}{{#SPRITES}}{{> h_sprite}}{{/SPRITES}}{{#TILEMAPARRAYS}}{{> h_tilemaparray}}{{/TILEMAPARRAYS}}{{#BLOCKMAPS}}{{> h_blockmap}}{{/BLOCKMAPS}}{{#SPRITEARRAYS}}{{> h_spritearray}}{{/SPRITEARRAYS}}{{#COLLISIONBLOCKARRAYS}}{{> h_collisionblockarray}}{{/COLLISIONBLOCKARRAYS}}
