...
constexpr const char* MAP_COUNT_TAG = "MAP_COUNT";
constexpr const char* MAP_HEIGHT_TAG = "MAP_HEIGHT";
constexpr const char* MAP_WIDTH_TAG = "MAP_WIDTH";
...
constexpr const char* TILEMAP_ARRAY_MAPS_TAG = "TILEMAPARRAYMAPS";
...
{{#TILEMAPARRAYS}}{{> c_tilemaparray}}{{/TILEMAPARRAYS}}
{{#TILEMAPARRAYMAPS}}{{> c_tilemaparraymap}}{{/TILEMAPARRAYMAPS}}
{{#SPRITES}}{{> c_sprite}}{{/SPRITES}}
{{#SPRITEARRAYS}}{{> c_spritearray}}{{/SPRITEARRAYS}}
)";
...
constexpr const char* C_TILEMAPARRAYMAP_TEMPLATE = R"(

const uint16_t {{NAME}}[{{NAME}}_MAP_COUNT] =
{
{{#ROWS}}
{{> indent}}{{ROW}}
{{/ROWS}}
...
{{#SPRITES}}{{> h_sprite}}{{/SPRITES}}
{{#TILEMAPARRAYS}}{{> h_tilemaparray}}{{/TILEMAPARRAYS}}
{{#TILEMAPARRAYMAPS}}{{> h_tilemaparraymap}}{{/TILEMAPARRAYMAPS}}
{{#SPRITEARRAYS}}{{> h_spritearray}}{{/SPRITEARRAYS}}
...
constexpr const char* H_TILEMAPARRAYMAP_TEMPLATE = R"(

#define {{NAME}}_MAP_WIDTH {{MAP_WIDTH}}
#define {{NAME}}_MAP_HEIGHT {{MAP_HEIGHT}}
#define {{NAME}}_MAP_COUNT {{MAP_COUNT}}
extern const uint16_t {{NAME}}[{{NAME}}_MAP_COUNT];
)";
