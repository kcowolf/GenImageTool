...
================================
These are some simple examples of how the graphical data generated by GenImageTool can be used in your program.  Where performance is a concern (lots of animated sprites, scrolling map, etc.), optimization may be needed.
...
-------
```
// Assuming player tiles are loaded after forest tiles in VRAM.
#define PLAYER_TILESET_START_IDX (FOREST_TILESET_START_IDX + TILESET_FOREST_TILE_COUNT)

VDP_setSpriteFull(0, 10, 10, SPRITE_SIZE(SPRITE_PLAYER_1_TILE_WIDTH, SPRITE_PLAYER_1_TILE_HEIGHT), TILE_ATTR_FULL(PAL1, 0, 0, 0, PLAYER_TILESET_START_IDX + SPRITE_PLAYER_1_TILE), 0);
...
-------------
```
VDP_setSpriteFull(0, 20, 20, SPRITE_SIZE(SPRITEARRAY_PLAYER_RUN_RIGHT_TILE_WIDTH, SPRITEARRAY_PLAYER_RUN_RIGHT_TILE_HEIGHT), TILE_ATTR_FULL(PAL1, 0, 0, 0, PLAYER_TILESET_START_IDX + SPRITEARRAY_PLAYER_RUN_RIGHT[1]), 0);
VDP_updateSprites(1, DMA_QUEUE);
```
